...
object PrefConstants {
    ...
    // 추천 TourItem 목록 저장 Shared Preference
    const val PREFERENCE_RECOMMEND_TOUR_ITEM_LIST_KEY = "PREFERENCE_RECOMMEND_TOUR_ITEM_LIST_KEY"
    const val RECOMMEND_TOUR_ITEM_LIST_KEY = "RECOMMEND_TOUR_ITEM_LIST_KEY"
